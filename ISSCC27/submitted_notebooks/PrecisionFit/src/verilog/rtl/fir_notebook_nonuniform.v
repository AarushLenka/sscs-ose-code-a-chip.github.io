...
`ifdef FORMAL_STREAM
    ...
    localparam signed [40:0] CC0 = 41'(14'sh0016) <<< 2;
    // CC1 = C1 << 2  (binary-point alignment for f_fir spec)
    localparam signed [40:0] CC1 = 41'(14'sh3ff2) <<< 2;
    // CC2 = C2 << 2  (binary-point alignment for f_fir spec)
    localparam signed [40:0] CC2 = 41'(14'sh3fa8) <<< 2;
    // CC3 = C3 << 4  (binary-point alignment for f_fir spec)
    localparam signed [40:0] CC3 = 41'(12'shfda) <<< 4;
    // CC4 = C4 << 0  (binary-point alignment for f_fir spec)
    localparam signed [40:0] CC4 = 41'(16'shfe86) <<< 0;
    // CC5 = C5 << 4  (binary-point alignment for f_fir spec)
    localparam signed [40:0] CC5 = 41'(12'sh02a) <<< 4;
    // CC6 = C6 << 0  (binary-point alignment for f_fir spec)
    localparam signed [40:0] CC6 = 41'(16'sh093a) <<< 0;
    // CC7 = C7 << 6  (binary-point alignment for f_fir spec)
    localparam signed [40:0] CC7 = 41'(10'sh03e) <<< 6;
    // CC8 = C8 << 6  (center tap)
    localparam signed [40:0] CC8 = 41'(10'sh048) <<< 6;
    function signed [40:0] f_fir;
