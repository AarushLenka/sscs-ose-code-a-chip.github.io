...
module fir_sensitivity_guided #(
    ...
    localparam signed [12:0] C5 = 13'sh0054;
    localparam signed [15:0] C6 = 16'sh093a;
    localparam signed [12:0] C7 = 13'sh01f0;
    localparam signed [12:0] C8 = 13'sh0243;
    ...
    wire signed [30:0] prod4 = fold4 * C4;
    wire signed [27:0] prod5 = fold5 * C5;
    wire signed [30:0] prod6 = fold6 * C6;
    ...
    // Python golden model.
    wire signed [30:0] term0 = {prod0, {2{1'b0}}};
    wire signed [30:0] term1 = prod1;
    wire signed [30:0] term2 = {prod2, {2{1'b0}}};
    wire signed [30:0] term3 = {prod3, {2{1'b0}}};
    wire signed [30:0] term4 = prod4;
    wire signed [30:0] term5 = {prod5, {3{1'b0}}};
    wire signed [30:0] term6 = prod6;
    wire signed [30:0] term7 = {prod7, {3{1'b0}}};
    wire signed [30:0] term8 = {prod_center[26], prod_center, {3{1'b0}}};

    wire signed [ACC_WIDTH-1:0] acc_sum = {{6{term0[30]}}, term0} + {{6{term1[30]}}, term1} + {{6{term2[30]}}, term2} + {{6{term3[30]}}, term3} + {{6{term4[30]}}, term4} + {{6{term5[30]}}, term5} + {{6{term6[30]}}, term6} + {{6{term7[30]}}, term7} + {{6{term8[30]}}, term8};
    ...
    wire signed [23:0] shifted = rounded[37:14];

    // output-format limits, already sign-extended to the shifted width
    localparam signed [23:0] OUT_MAX = 24'sh001fff;
    localparam signed [23:0] OUT_MIN = 24'shffe000;
