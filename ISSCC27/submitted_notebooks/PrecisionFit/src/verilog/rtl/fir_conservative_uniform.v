...
module fir_conservative_uniform #(
    ...
    localparam signed [15:0] C0 = 16'sh0057;
    localparam signed [15:0] C1 = 16'shffc6;
    localparam signed [15:0] C2 = 16'shfea0;
    localparam signed [15:0] C3 = 16'shfda0;
    localparam signed [15:0] C4 = 16'shfe86;
    localparam signed [15:0] C5 = 16'sh029d;
    localparam signed [15:0] C6 = 16'sh093a;
    localparam signed [15:0] C7 = 16'sh0f83;
    localparam signed [15:0] C8 = 16'sh121b;
    ...
    wire signed [18:0] fold0 =
        {sr[0][IN_WIDTH-1], sr[0]} + {sr[16][IN_WIDTH-1], sr[16]};
    wire signed [18:0] fold1 =
        {sr[1][IN_WIDTH-1], sr[1]} + {sr[15][IN_WIDTH-1], sr[15]};
    wire signed [18:0] fold2 =
        {sr[2][IN_WIDTH-1], sr[2]} + {sr[14][IN_WIDTH-1], sr[14]};
    wire signed [18:0] fold3 =
        {sr[3][IN_WIDTH-1], sr[3]} + {sr[13][IN_WIDTH-1], sr[13]};
    wire signed [18:0] fold4 =
        {sr[4][IN_WIDTH-1], sr[4]} + {sr[12][IN_WIDTH-1], sr[12]};
    wire signed [18:0] fold5 =
        {sr[5][IN_WIDTH-1], sr[5]} + {sr[11][IN_WIDTH-1], sr[11]};
    wire signed [18:0] fold6 =
        {sr[6][IN_WIDTH-1], sr[6]} + {sr[10][IN_WIDTH-1], sr[10]};
    wire signed [18:0] fold7 =
        {sr[7][IN_WIDTH-1], sr[7]} + {sr[9][IN_WIDTH-1], sr[9]};

    // ---- constant multipliers (one per unique coefficient) ----------------------
    wire signed [34:0] prod0 = fold0 * C0;
    wire signed [34:0] prod1 = fold1 * C1;
    wire signed [34:0] prod2 = fold2 * C2;
    wire signed [34:0] prod3 = fold3 * C3;
    wire signed [34:0] prod4 = fold4 * C4;
    wire signed [34:0] prod5 = fold5 * C5;
    wire signed [34:0] prod6 = fold6 * C6;
    wire signed [34:0] prod7 = fold7 * C7;
    wire signed [33:0] prod_center = sr[8] * C8;
    ...
    // Python golden model.
    wire signed [34:0] term0 = prod0;
    wire signed [34:0] term1 = prod1;
    wire signed [34:0] term2 = prod2;
    wire signed [34:0] term3 = prod3;
    wire signed [34:0] term4 = prod4;
    wire signed [34:0] term5 = prod5;
    wire signed [34:0] term6 = prod6;
    wire signed [34:0] term7 = prod7;
    wire signed [34:0] term8 = {prod_center[33], prod_center};

    wire signed [ACC_WIDTH-1:0] acc_sum = {{8{term0[34]}}, term0} + {{8{term1[34]}}, term1} + {{8{term2[34]}}, term2} + {{8{term3[34]}}, term3} + {{8{term4[34]}}, term4} + {{8{term5[34]}}, term5} + {{8{term6[34]}}, term6} + {{8{term7[34]}}, term7} + {{8{term8[34]}}, term8};
    ...
    localparam SHIFT = 14;
    // verilator lint_on UNUSEDPARAM
    localparam signed [ACC_WIDTH:0] ROUND_CONST = 44'sh00000002000;
    ...
    wire signed [29:0] shifted = rounded[43:14];

    // output-format limits, already sign-extended to the shifted width
    localparam signed [29:0] OUT_MAX = 30'sh0001ffff;
    localparam signed [29:0] OUT_MIN = 30'sh3ffe0000;
...
`ifdef FORMAL_STREAM
    ...
    localparam signed [42:0] CC0 = 43'(16'sh0057) <<< 0;
    // CC1 = C1 << 0  (binary-point alignment for f_fir spec)
    localparam signed [42:0] CC1 = 43'(16'shffc6) <<< 0;
    // CC2 = C2 << 0  (binary-point alignment for f_fir spec)
    localparam signed [42:0] CC2 = 43'(16'shfea0) <<< 0;
    // CC3 = C3 << 0  (binary-point alignment for f_fir spec)
    localparam signed [42:0] CC3 = 43'(16'shfda0) <<< 0;
    // CC4 = C4 << 0  (binary-point alignment for f_fir spec)
    localparam signed [42:0] CC4 = 43'(16'shfe86) <<< 0;
    // CC5 = C5 << 0  (binary-point alignment for f_fir spec)
    localparam signed [42:0] CC5 = 43'(16'sh029d) <<< 0;
    // CC6 = C6 << 0  (binary-point alignment for f_fir spec)
    localparam signed [42:0] CC6 = 43'(16'sh093a) <<< 0;
    // CC7 = C7 << 0  (binary-point alignment for f_fir spec)
    localparam signed [42:0] CC7 = 43'(16'sh0f83) <<< 0;
    // CC8 = C8 << 0  (center tap)
    localparam signed [42:0] CC8 = 43'(16'sh121b) <<< 0;
    function signed [42:0] f_fir;
...
`ifndef FORMAL_STALL_ONLY
    function signed [29:0] f_requant;
        input signed [42:0] a;
        reg signed [43:0] r;
        reg signed [29:0] s;
        reg [17:0] t;
        begin
            r = {a[42], a} + 44'sh00000002000;
            s = r[43:14];
            if (s > OUT_MAX)
                t = OUT_MAX[17:0];
            else if (s < OUT_MIN)
