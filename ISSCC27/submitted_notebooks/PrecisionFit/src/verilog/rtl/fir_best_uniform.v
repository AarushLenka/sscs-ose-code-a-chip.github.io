...
//   [0, 0, 0, 0, 0, 0, 0, 0, 0]
//
// coeff: Q2.12 (max frac width used)
// input: Q2.11
// acc:   signed 36 bits, fraction at bit 23
// out:   Q2.11
// requantize: >>> 12, rounding=round, saturate=True
//
// Licensed under the Apache License, Version 2.0. See the repo LICENSE file.

module fir_best_uniform #(
    parameter N_TAPS      = 17,
    ...
    localparam signed [13:0] C3 = 14'sh3f68;
    localparam signed [13:0] C4 = 14'sh3fa1;
    localparam signed [13:0] C5 = 14'sh00a7;
    localparam signed [13:0] C6 = 14'sh024f;
    localparam signed [13:0] C7 = 14'sh03e1;
    localparam signed [13:0] C8 = 14'sh0487;
    ...
    wire signed [13:0] fold0 =
        {sr[0][IN_WIDTH-1], sr[0]} + {sr[16][IN_WIDTH-1], sr[16]};
    wire signed [13:0] fold1 =
        {sr[1][IN_WIDTH-1], sr[1]} + {sr[15][IN_WIDTH-1], sr[15]};
    wire signed [13:0] fold2 =
        {sr[2][IN_WIDTH-1], sr[2]} + {sr[14][IN_WIDTH-1], sr[14]};
    wire signed [13:0] fold3 =
        {sr[3][IN_WIDTH-1], sr[3]} + {sr[13][IN_WIDTH-1], sr[13]};
    wire signed [13:0] fold4 =
        {sr[4][IN_WIDTH-1], sr[4]} + {sr[12][IN_WIDTH-1], sr[12]};
    wire signed [13:0] fold5 =
        {sr[5][IN_WIDTH-1], sr[5]} + {sr[11][IN_WIDTH-1], sr[11]};
    wire signed [13:0] fold6 =
        {sr[6][IN_WIDTH-1], sr[6]} + {sr[10][IN_WIDTH-1], sr[10]};
    wire signed [13:0] fold7 =
        {sr[7][IN_WIDTH-1], sr[7]} + {sr[9][IN_WIDTH-1], sr[9]};

    // ---- constant multipliers (one per unique coefficient) ----------------------
    wire signed [27:0] prod0 = fold0 * C0;
    wire signed [27:0] prod1 = fold1 * C1;
    wire signed [27:0] prod2 = fold2 * C2;
    wire signed [27:0] prod3 = fold3 * C3;
    wire signed [27:0] prod4 = fold4 * C4;
    wire signed [27:0] prod5 = fold5 * C5;
    wire signed [27:0] prod6 = fold6 * C6;
    wire signed [27:0] prod7 = fold7 * C7;
    wire signed [26:0] prod_center = sr[8] * C8;
    ...
    // Python golden model.
    wire signed [27:0] term0 = prod0;
    wire signed [27:0] term1 = prod1;
    wire signed [27:0] term2 = prod2;
    wire signed [27:0] term3 = prod3;
    wire signed [27:0] term4 = prod4;
    wire signed [27:0] term5 = prod5;
    wire signed [27:0] term6 = prod6;
    wire signed [27:0] term7 = prod7;
    wire signed [27:0] term8 = {prod_center[26], prod_center};

    wire signed [ACC_WIDTH-1:0] acc_sum = {{8{term0[27]}}, term0} + {{8{term1[27]}}, term1} + {{8{term2[27]}}, term2} + {{8{term3[27]}}, term3} + {{8{term4[27]}}, term4} + {{8{term5[27]}}, term5} + {{8{term6[27]}}, term6} + {{8{term7[27]}}, term7} + {{8{term8[27]}}, term8};
    ...
    localparam SHIFT = 12;
    // verilator lint_on UNUSEDPARAM
    localparam signed [ACC_WIDTH:0] ROUND_CONST = 37'sh0000000800;
    ...
    wire signed [24:0] shifted = rounded[36:12];

    // output-format limits, already sign-extended to the shifted width
    localparam signed [24:0] OUT_MAX = 25'sh0000fff;
    localparam signed [24:0] OUT_MIN = 25'sh1fff000;
...
`ifdef FORMAL_STREAM
    ...
    localparam signed [35:0] CC0 = 36'(14'sh0016) <<< 0;
    // CC1 = C1 << 0  (binary-point alignment for f_fir spec)
    localparam signed [35:0] CC1 = 36'(14'sh3ff2) <<< 0;
    // CC2 = C2 << 0  (binary-point alignment for f_fir spec)
    localparam signed [35:0] CC2 = 36'(14'sh3fa8) <<< 0;
    // CC3 = C3 << 0  (binary-point alignment for f_fir spec)
    localparam signed [35:0] CC3 = 36'(14'sh3f68) <<< 0;
    // CC4 = C4 << 0  (binary-point alignment for f_fir spec)
    localparam signed [35:0] CC4 = 36'(14'sh3fa1) <<< 0;
    // CC5 = C5 << 0  (binary-point alignment for f_fir spec)
    localparam signed [35:0] CC5 = 36'(14'sh00a7) <<< 0;
    // CC6 = C6 << 0  (binary-point alignment for f_fir spec)
    localparam signed [35:0] CC6 = 36'(14'sh024f) <<< 0;
    // CC7 = C7 << 0  (binary-point alignment for f_fir spec)
    localparam signed [35:0] CC7 = 36'(14'sh03e1) <<< 0;
    // CC8 = C8 << 0  (center tap)
    localparam signed [35:0] CC8 = 36'(14'sh0487) <<< 0;
    function signed [35:0] f_fir;
...
`ifndef FORMAL_STALL_ONLY
    function signed [24:0] f_requant;
        input signed [35:0] a;
        reg signed [36:0] r;
        reg signed [24:0] s;
        reg [12:0] t;
        begin
            r = {a[35], a} + 37'sh0000000800;
            s = r[36:12];
            if (s > OUT_MAX)
                t = OUT_MAX[12:0];
            else if (s < OUT_MIN)
